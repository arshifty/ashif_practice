...
export class AddCustomerComponent implements OnInit {
  ...
  savePrimary() {
    ...
    if (this.primaryContactForm.valid) {
      ...
      let data = { ...this.primaryContactForm.value }
  ...
  savebill() {
    ...
    if (this.billContactForm.valid) {
      this.submitted = false;
      let data = { ...this.billContactForm.value }

      data.club_id = this.club_id;
      data.contact_type = "bill";
  ...
  save() {
    if (this.orgDetailForm.valid) {
      ...
      data.organization_type = "organization";
